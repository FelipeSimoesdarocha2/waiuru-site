...
const NewsSection = () => {
    ...
    const nextSlide = () => {
        setCurrentSlide((currentSlide + 1) % list.length);
    };
        ...
        <S.Container>
            <div className="first_child">
                <div className="typography">
                    <h2 className="title">
                        {t('newsSection.title')}
                        <span>{t('newsSection.title_last')}</span>
                    </h2>
                    <p>{t('newsSection.sub_title')}</p>
                </div>
                {!isMobile && (
                    <div className="actions">
                        <Button label={t('newsSection.action.label')} type="primary" onClick={() => router.push('/news')} />
                        <div className="control">
                            <button onClick={prevSlide} aria-label="prev">
