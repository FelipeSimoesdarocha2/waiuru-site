...
const list_benefits = [
  {
    id: '1',
    name: 'solutions.administrators.benefits.list.payment',
  },
  {
    id: '2',
    name: 'solutions.administrators.benefits.list.lost_and_found',
  },
  {
    id: '3',
    name: 'solutions.administrators.benefits.list.visits',
  },
  {
    id: '4',
    name: 'solutions.administrators.benefits.list.environment_reserves',
  },
  {
    id: '5',
    name: 'solutions.administrators.benefits.list.occurrences',
  },
  {
    id: '6',
    name: 'solutions.administrators.benefits.list.communication',
  },
  {
    id: '7',
    name: 'solutions.administrators.benefits.list.ordinance',
  },
  {
    id: '8',
    name: 'solutions.administrators.benefits.list.information',
  },
];

const dataAdministrators: CardSolutionsProps['data'] = [
  {
    id: 1,
...
export { our_solutions, links, screen, list_benefits, dataAdministrators };
