...
const list_benefits = [
  {
    id: '1',
    name: 'solutions.resident.benefits.list.service',
  },
  {
    id: '2',
    name: 'solutions.resident.benefits.list.online_voting',
  },
  {
    id: '3',
    name: 'solutions.resident.benefits.list.visits',
  },
  {
    id: '4',
    name: 'solutions.resident.benefits.list.payment',
  },
  {
    id: '5',
    name: 'solutions.resident.benefits.list.orders',
  },
  {
    id: '6',
    name: 'solutions.resident.benefits.list.lost_and_found',
  },
  {
    id: '7',
    name: 'solutions.resident.benefits.list.condominium_environments',
  },
  {
    id: '8',
    name: 'solutions.resident.benefits.list.communication',
  },
];

const dataResidents: CardSolutionsProps['data'] = [
  {
    id: 1,
...
export { our_solutions, links, screen, list_benefits, dataResidents };
