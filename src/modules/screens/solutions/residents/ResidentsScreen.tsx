  ...
  const renderSelectedScreen = () => {
    switch (selectedScreen) {
      case 1:
        return <Presentation />;
      case 2:
        return <CardSolutions data={dataResidents} />;
      default:
        return null;
    }
  };
  ...
  return (
    <S.Container>
      <div className="hero">
        ...
        <div className="inner">
          <div className="typography">
            <strong>{t(isMobile ? 'solutions.resident.label_mobile' : 'solutions.resident.label')}</strong>
            <h2>{t(isMobile ? 'solutions.resident.title_mobile' : 'solutions.resident.title')}</h2>
            <div className="paragraph">
              <p>{t(isMobile ? 'solutions.resident.sub_title_mobile' : 'solutions.resident.sub_title')}</p>
              {!isMobile && <p>{t('solutions.resident.sub_title_secondaty')}</p>}
              {!isMobile && <p>{t('solutions.resident.sub_title_tertiary')}</p>}
            </div>
          </div>

          <div className="link">
            <div className="actions">
              <Button label={t('Solicitar demonstração')} type="primary" onClick={() => router.push('/register')} />
            </div>
            <div className="link_typography">
              <strong>{t('solutions.link.available')}</strong>
              <p>{t('solutions.link.on_the')}</p>
              <Link
                href={'https://apps.apple.com/us/app/waiuru-for-residents/id6467805565'}
                draggable="false"
                target="blank"
              >
                Apple
            ...
            <div className="download">
              <Link href={'https://play.google.com/store/apps/details?id=com.waiuru.myHome'} target="blank">
                <Image src={play_store} alt="play_store" draggable="false" />
              </Link>
              <Link href={'https://apps.apple.com/us/app/waiuru-for-residents/id6467805565'} target="blank">
      ...
      <div className="content_screen">
        ...
        <div className="inner">
          <Image src={decore_trail} className="decore_trail" alt="decore" draggable="false" />
          {!isMobile ? (
            <h2 className="title">
            ...
            <p className="title_mobile">{t('solutions.config.title_mobile')}</p>
          )}
      ...
      <div className="benefits">
        <h2>{t('solutions.resident.benefits.title')}</h2>
      ...
      <OurSolutions
        data={our_solutions.map(e => ({
          ...
          action: {
            ...e.action,
            label: isMobile ? `${t('solutions.resident.ourSolutions.view_more')}` : e.action.label,
          },
        }))}
        title={isMobile ? 'solutions.resident.ourSolutions.title_mobile' : 'solutions.resident.ourSolutions.title'}
        sub_title={'solutions.resident.ourSolutions.sub_title'}
      />
